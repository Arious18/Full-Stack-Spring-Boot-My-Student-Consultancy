  ...
  "node_modules/lodash/_stackSet.js"(exports, module) {
    ...
    function stackSet(key, value) {
      ...
      if (data instanceof ListCache) {
        ...
        if (!Map2 || pairs5.length < LARGE_ARRAY_SIZE - 1) {
          pairs5.push([key, value]);
          this.size = ++data.size;
          return this;
        }
        data = this.__data__ = new MapCache(pairs5);
      }
      data.set(key, value);
      this.size = data.size;
      return this;
...
var require_identity = __commonJS({
  "node_modules/lodash/identity.js"(exports, module) {
    function identity12(value) {
      return value;
    }
    module.exports = identity12;
  }
});
...
var require_overRest = __commonJS({
  "node_modules/lodash/_overRest.js"(exports, module) {
    ...
    function overRest(func, start2, transform) {
      ...
      return function() {
        var args = arguments, index5 = -1, length = nativeMax(args.length - start2, 0), array5 = Array(length);
        while (++index5 < length) {
          array5[index5] = args[start2 + index5];
        }
        index5 = -1;
...
var require_baseSetToString = __commonJS({
  "node_modules/lodash/_baseSetToString.js"(exports, module) {
    ...
    var defineProperty = require_defineProperty();
    var identity12 = require_identity();
    var baseSetToString = !defineProperty ? identity12 : function(func, string) {
...
var require_baseRest = __commonJS({
  "node_modules/lodash/_baseRest.js"(exports, module) {
    ...
    function baseRest(func, start2) {
      return setToString(overRest(func, start2, identity12), func + "");
    }
...
var require_isIterateeCall = __commonJS({
  "node_modules/lodash/_isIterateeCall.js"(exports, module) {
    ...
    function isIterateeCall(value, index5, object) {
      ...
      if (type == "number" ? isArrayLike(object) && isIndex(index5, object.length) : type == "string" && index5 in object) {
        return eq(object[index5], value);
      }
      return false;
    }
...
var require_arrayMap = __commonJS({
  "node_modules/lodash/_arrayMap.js"(exports, module) {
    function arrayMap(array5, iteratee) {
      var index5 = -1, length = array5 == null ? 0 : array5.length, result = Array(length);
      while (++index5 < length) {
        result[index5] = iteratee(array5[index5], index5, array5);
      }
      return result;
    }
...
var require_baseGet = __commonJS({
  "node_modules/lodash/_baseGet.js"(exports, module) {
    ...
    function baseGet(object, path2) {
      ...
      var index5 = 0, length = path2.length;
      while (object != null && index5 < length) {
        object = object[toKey(path2[index5++])];
      }
...
var require_baseSet = __commonJS({
  "node_modules/lodash/_baseSet.js"(exports, module) {
    ...
    function baseSet(object, path2, value, customizer) {
      ...
      path2 = castPath(path2, object);
      var index5 = -1, length = path2.length, lastIndex = length - 1, nested = object;
      while (nested != null && ++index5 < length) {
        var key = toKey(path2[index5]), newValue = value;
        ...
        if (index5 != lastIndex) {
          ...
          if (newValue === void 0) {
            newValue = isObject(objValue) ? objValue : isIndex(path2[index5 + 1]) ? [] : {};
          }
        }
...
var require_set = __commonJS({
  "node_modules/lodash/set.js"(exports, module) {
    ...
    function set5(object, path2, value) {
...
var require_baseFindIndex = __commonJS({
  "node_modules/lodash/_baseFindIndex.js"(exports, module) {
    function baseFindIndex(array5, predicate, fromIndex, fromRight) {
      var length = array5.length, index5 = fromIndex + (fromRight ? 1 : -1);
      while (fromRight ? index5-- : ++index5 < length) {
        if (predicate(array5[index5], index5, array5)) {
          return index5;
        }
      }
      return -1;
...
var require_strictIndexOf = __commonJS({
  "node_modules/lodash/_strictIndexOf.js"(exports, module) {
    function strictIndexOf(array5, value, fromIndex) {
      var index5 = fromIndex - 1, length = array5.length;
      while (++index5 < length) {
        if (array5[index5] === value) {
          return index5;
        }
      }
      return -1;
...
var require_arrayIncludesWith = __commonJS({
  "node_modules/lodash/_arrayIncludesWith.js"(exports, module) {
    function arrayIncludesWith(array5, value, comparator) {
      var index5 = -1, length = array5 == null ? 0 : array5.length;
      while (++index5 < length) {
        if (comparator(value, array5[index5])) {
          return true;
        }
      }
      return false;
...
var require_baseDifference = __commonJS({
  "node_modules/lodash/_baseDifference.js"(exports, module) {
    ...
    var LARGE_ARRAY_SIZE = 200;
    function baseDifference(array5, values, iteratee, comparator) {
      var index5 = -1, includes = arrayIncludes, isCommon = true, length = array5.length, result = [], valuesLength = values.length;
      if (!length) {
        return result;
      }
      if (iteratee) {
      ...
      outer:
        while (++index5 < length) {
          var value = array5[index5], computed = iteratee == null ? value : iteratee(value);
...
var require_without = __commonJS({
  "node_modules/lodash/without.js"(exports, module) {
    ...
    var baseRest = require_baseRest();
    var isArrayLikeObject = require_isArrayLikeObject();
    var without = baseRest(function(array5, values) {
      return isArrayLikeObject(array5) ? baseDifference(array5, values) : [];
    });
...
var require_basePickBy = __commonJS({
  "node_modules/lodash/_basePickBy.js"(exports, module) {
    ...
    function basePickBy(object, paths, predicate) {
      ...
      while (++index5 < length) {
        var path2 = paths[index5], value = baseGet(object, path2);
...
var require_hasPath = __commonJS({
  "node_modules/lodash/_hasPath.js"(exports, module) {
    ...
    function hasPath(object, path2, hasFunc) {
      path2 = castPath(path2, object);
      var index5 = -1, length = path2.length, result = false;
      while (++index5 < length) {
        var key = toKey(path2[index5]);
...
var require_arrayPush = __commonJS({
  "node_modules/lodash/_arrayPush.js"(exports, module) {
    function arrayPush(array5, values) {
      var index5 = -1, length = values.length, offset = array5.length;
      while (++index5 < length) {
        array5[offset + index5] = values[index5];
      }
      return array5;
    }
...
var require_baseFlatten = __commonJS({
  "node_modules/lodash/_baseFlatten.js"(exports, module) {
    ...
    function baseFlatten(array5, depth, predicate, isStrict, result) {
      var index5 = -1, length = array5.length;
      predicate || (predicate = isFlattenable);
      result || (result = []);
      while (++index5 < length) {
        var value = array5[index5];
...
var require_equalArrays = __commonJS({
  "node_modules/lodash/_equalArrays.js"(exports, module) {
    ...
    function equalArrays(array5, other, bitmask, customizer, equalFunc, stack) {
      ...
      var index5 = -1, result = true, seen = bitmask & COMPARE_UNORDERED_FLAG ? new SetCache() : void 0;
      stack.set(array5, other);
      stack.set(other, array5);
      while (++index5 < arrLength) {
        var arrValue = array5[index5], othValue = other[index5];
        if (customizer) {
          var compared = isPartial ? customizer(othValue, arrValue, index5, other, array5, stack) : customizer(arrValue, othValue, index5, array5, other, stack);
        }
        if (compared !== void 0) {
          if (compared) {
            continue;
...
var require_mapToArray = __commonJS({
  "node_modules/lodash/_mapToArray.js"(exports, module) {
    function mapToArray(map10) {
      var index5 = -1, result = Array(map10.size);
...
var require_setToArray = __commonJS({
  "node_modules/lodash/_setToArray.js"(exports, module) {
    function setToArray(set5) {
      var index5 = -1, result = Array(set5.size);
...
var require_arrayFilter = __commonJS({
  "node_modules/lodash/_arrayFilter.js"(exports, module) {
    function arrayFilter(array5, predicate) {
      var index5 = -1, length = array5 == null ? 0 : array5.length, resIndex = 0, result = [];
      while (++index5 < length) {
        var value = array5[index5];
        if (predicate(value, index5, array5)) {
...
function update() {
  const prevTs = ts;
  ts = raf.now();
  const count5 = findTimeout(ts);
  if (count5) {
    eachSafely(timeouts.splice(0, count5), (t6) => t6.handler());
    pendingCount -= count5;
  }
  if (!pendingCount) {
    stop();
...
function findIndex(arr, test) {
  const index5 = arr.findIndex(test);
  return index5 < 0 ? arr.length : index5;
}
var clamp = (min6, max6, v4) => Math.min(Math.max(v4, min6), max6);
var colors2 = {
  transparent: 0,
...
function removeFluidObserver(target, observer2) {
  ...
  if (observers && observers.has(observer2)) {
    ...
    if (target.observerRemoved) {
      target.observerRemoved(count5, observer2);
    }
  }
}
...
var FrameValue = class extends FluidValue {
  ...
  observerAdded(count5) {
    if (count5 == 1)
      this._attach();
  }
  observerRemoved(count5) {
    if (count5 == 0)
      this._detach();
  }
...
function createLoopUpdate(props, loop2 = props.loop, to22 = props.to) {
  ...
  if (loopRet) {
    ...
    const reverse5 = (overrides || props).reverse;
    ...
    return createUpdate({
      ...
      to: !reverse5 || isAsyncTo(to22) ? to22 : void 0,
...
var SpringRef = () => {
  ...
  const _getProps = function(arg, ctrl, index5) {
    return is.fun(arg) ? arg(index5, ctrl) : arg;
  };
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort5)) {
    transitions.sort((a4, b3) => sort5(a4.item, b3.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
function hslConvert(o3) {
  ...
  o3 = o3.rgb();
  var r3 = o3.r / 255, g3 = o3.g / 255, b3 = o3.b / 255, min6 = Math.min(r3, g3, b3), max6 = Math.max(r3, g3, b3), h2 = NaN, s4 = max6 - min6, l3 = (max6 + min6) / 2;
  if (s4) {
    if (r3 === max6) h2 = (g3 - b3) / s4 + (g3 < b3) * 6;
    else if (g3 === max6) h2 = (b3 - r3) / s4 + 2;
    else h2 = (r3 - g3) / s4 + 4;
    s4 /= l3 < 0.5 ? max6 + min6 : 2 - max6 - min6;
    h2 *= 60;
  } else {
    s4 = l3 > 0 && l3 < 1 ? 0 : h2;
  }
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh6 = Math.cos(h2), sinh6 = Math.sin(h2);
    return new Rgb(
      255 * (l3 + a4 * (A * cosh6 + B * sinh6)),
      255 * (l3 + a4 * (C * cosh6 + D * sinh6)),
      255 * (l3 + a4 * (E * cosh6)),
      this.opacity
    );
  }
...
function basis(t110, v0, v1, v22, v32) {
  var t26 = t110 * t110, t36 = t26 * t110;
  return ((1 - 3 * t110 + 3 * t26 - t36) * v0 + (4 - 6 * t26 + 3 * t36) * v1 + (1 + 3 * t110 + 3 * t26 - 3 * t36) * v22 + t36 * v32) / 6;
}
...
function hsl3(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hsl2(start2)).h, (end = hsl2(end)).h), s4 = nogamma(start2.s, end.s), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
function hcl2(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hcl(start2)).h, (end = hcl(end)).h), c11 = nogamma(start2.c, end.c), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c11(t6);
      start2.l = l3(t6);
...
function cubehelix2(hue6) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix11(start2, end) {
      var h2 = hue6((start2 = cubehelix(start2)).h, (end = cubehelix(end)).h), s4 = nogamma(start2.s, end.s), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
    ...
    cubehelix11.gamma = cubehelixGamma;
    return cubehelix11;
  }(1);
}
...
var e5 = Math.sqrt(10);
var e2 = Math.sqrt(2);
function ticks_default(start2, stop2, count5) {
  var reverse5, i3 = -1, n3, ticks, step;
  stop2 = +stop2, start2 = +start2, count5 = +count5;
  if (start2 === stop2 && count5 > 0) return [start2];
  if (reverse5 = stop2 < start2) n3 = start2, start2 = stop2, stop2 = n3;
  if ((step = tickIncrement(start2, stop2, count5)) === 0 || !isFinite(step)) return [];
  if (step > 0) {
  ...
  if (reverse5) ticks.reverse();
  return ticks;
}
function tickIncrement(start2, stop2, count5) {
  var step = (stop2 - start2) / Math.max(0, count5), power = Math.floor(Math.log(step) / Math.LN10), error = step / Math.pow(10, power);
  return power >= 0 ? (error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1) * Math.pow(10, power) : -Math.pow(10, -power) / (error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1);
}
function tickStep(start2, stop2, count5) {
  var step0 = Math.abs(stop2 - start2) / Math.max(0, count5), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
...
function shuffler(random) {
  return function shuffle(array5, i0 = 0, i1 = array5.length) {
    let m4 = i1 - (i0 = +i0);
    while (m4) {
      const i3 = random() * m4-- | 0, t6 = array5[m4 + i0];
      array5[m4 + i0] = array5[i3 + i0];
      array5[i3 + i0] = t6;
    }
    return array5;
  };
...
function ordinal() {
  var index5 = /* @__PURE__ */ new Map(), domain = [], range = [], unknown = implicit;
  function scale(d3) {
    var key = d3 + "", i3 = index5.get(key);
    if (!i3) {
      if (unknown !== implicit) return unknown;
      index5.set(key, i3 = domain.push(d3));
    }
    return range[(i3 - 1) % range.length];
  }
  scale.domain = function(_) {
    if (!arguments.length) return domain.slice();
    domain = [], index5 = /* @__PURE__ */ new Map();
    for (const value of _) {
      const key = value + "";
      if (index5.has(key)) continue;
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-color/src/define.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-color/src/color.js
function Color2() {
}
var darker2 = 0.7;
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-color/src/math.js
var radians2 = Math.PI / 180;
var degrees3 = 180 / Math.PI;

// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-color/src/lab.js
var K2 = 18;
var Xn2 = 0.96422;
var Yn2 = 1;
var Zn2 = 0.82521;
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-color/src/cubehelix.js
var A2 = -0.14861;
var B2 = 1.78277;
var C2 = -0.29227;
var D2 = -0.90649;
...
define_default2(Cubehelix2, cubehelix3, extend2(Color2, {
  ...
  rgb: function() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians2, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh6 = Math.cos(h2), sinh6 = Math.sin(h2);
    return new Rgb2(
      255 * (l3 + a4 * (A2 * cosh6 + B2 * sinh6)),
      255 * (l3 + a4 * (C2 * cosh6 + D2 * sinh6)),
      255 * (l3 + a4 * (E2 * cosh6)),
      this.opacity
    );
  }
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/basis.js
function basis2(t110, v0, v1, v22, v32) {
  var t26 = t110 * t110, t36 = t26 * t110;
  return ((1 - 3 * t110 + 3 * t26 - t36) * v0 + (4 - 6 * t26 + 3 * t36) * v1 + (1 + 3 * t110 + 3 * t26 - 3 * t36) * v22 + t36 * v32) / 6;
}
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/basisClosed.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/constant.js
var constant_default3 = (x5) => () => x5;

// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/color.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/rgb.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/number.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/string.js
var reA2 = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
var reB2 = new RegExp(reA2.source, "g");

// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/transform/decompose.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/transform/parse.js
var svgNode2;
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/transform/index.js
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/zoom.js
var epsilon22 = 1e-12;
function cosh2(x5) {
  return ((x5 = Math.exp(x5)) + 1 / x5) / 2;
}
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/hsl.js
function hsl5(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hsl4(start2)).h, (end = hsl4(end)).h), s4 = nogamma2(start2.s, end.s), l3 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/hcl.js
function hcl4(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hcl3(start2)).h, (end = hcl3(end)).h), c11 = nogamma2(start2.c, end.c), l3 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c11(t6);
      start2.l = l3(t6);
...
// node_modules/@nivo/core/node_modules/d3-scale/node_modules/d3-interpolate/src/cubehelix.js
function cubehelix4(hue6) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix11(start2, end) {
      var h2 = hue6((start2 = cubehelix3(start2)).h, (end = cubehelix3(end)).h), s4 = nogamma2(start2.s, end.s), l3 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
        start2.l = l3(Math.pow(t6, y4));
...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    function format2(value) {
      ...
      if (comma && !zero2) value = group5(value, Infinity);
      var length = valuePrefix.length + value.length + valueSuffix.length, padding = length < width ? new Array(width - length + 1).join(fill) : "";
      if (comma && zero2) value = group5(padding + value, padding.length ? width - valueSuffix.length : Infinity), padding = "";
      switch (align) {
        case "<":
...
function tickFormat(start2, stop2, count5, specifier) {
  var step = tickStep(start2, stop2, count5), precision;
...
function linearish(scale) {
  ...
  scale.ticks = function(count5) {
    var d3 = domain();
    return ticks_default(d3[0], d3[d3.length - 1], count5 == null ? 10 : count5);
  };
  scale.tickFormat = function(count5, specifier) {
    var d3 = domain();
    return tickFormat(d3[0], d3[d3.length - 1], count5 == null ? 10 : count5, specifier);
  };
  scale.nice = function(count5) {
    ...
    while (maxIter-- > 0) {
      step = tickIncrement(start2, stop2, count5);
      if (step === prestep) {
        d3[i0] = start2;
        d3[i1] = stop2;
        return domain(d3);
...
function ticker(year5, month5, week, day5, hour5, minute5) {
  const tickIntervals = [
    [second_default, 1, durationSecond],
    [second_default, 5, 5 * durationSecond],
    [second_default, 15, 15 * durationSecond],
    [second_default, 30, 30 * durationSecond],
    [minute5, 1, durationMinute],
    [minute5, 5, 5 * durationMinute],
    [minute5, 15, 15 * durationMinute],
    [minute5, 30, 30 * durationMinute],
    [hour5, 1, durationHour],
    [hour5, 3, 3 * durationHour],
    [hour5, 6, 6 * durationHour],
    [hour5, 12, 12 * durationHour],
    [day5, 1, durationDay],
    [day5, 2, 2 * durationDay],
    [week, 1, durationWeek],
    [month5, 1, durationMonth],
    [month5, 3, 3 * durationMonth],
    [year5, 1, durationYear]
  ];
  function ticks(start2, stop2, count5) {
    const reverse5 = stop2 < start2;
    if (reverse5) [start2, stop2] = [stop2, start2];
    const interval = count5 && typeof count5.range === "function" ? count5 : tickInterval(start2, stop2, count5);
    const ticks2 = interval ? interval.range(start2, +stop2 + 1) : [];
    return reverse5 ? ticks2.reverse() : ticks2;
  }
  function tickInterval(start2, stop2, count5) {
    const target = Math.abs(stop2 - start2) / count5;
    const i3 = bisector_default(([, , step2]) => step2).right(tickIntervals, target);
    if (i3 === tickIntervals.length) return year5.every(tickStep(start2 / durationYear, stop2 / durationYear, count5));
    if (i3 === 0) return millisecond_default.every(Math.max(tickStep(start2, stop2, count5), 1));
...
function newInterval2(floori, offseti, count5, field) {
  function interval(date) {
    return floori(date = arguments.length === 0 ? /* @__PURE__ */ new Date() : /* @__PURE__ */ new Date(+date)), date;
  }
  interval.floor = function(date) {
...
function ascending_default2(a4, b3) {
  return a4 < b3 ? -1 : a4 > b3 ? 1 : a4 >= b3 ? 0 : NaN;
}
...
var e22 = Math.sqrt(2);
function tickStep2(start2, stop2, count5) {
  var step0 = Math.abs(stop2 - start2) / Math.max(0, count5), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
...
function ticker2(year5, month5, week, day5, hour5, minute5) {
  const tickIntervals = [
    ...
    [minute5, 1, durationMinute2],
    [minute5, 5, 5 * durationMinute2],
    [minute5, 15, 15 * durationMinute2],
    [minute5, 30, 30 * durationMinute2],
    [hour5, 1, durationHour2],
    [hour5, 3, 3 * durationHour2],
    [hour5, 6, 6 * durationHour2],
    [hour5, 12, 12 * durationHour2],
    [day5, 1, durationDay2],
    [day5, 2, 2 * durationDay2],
    [week, 1, durationWeek2],
    [month5, 1, durationMonth2],
    [month5, 3, 3 * durationMonth2],
    [year5, 1, durationYear2]
  ];
  function ticks(start2, stop2, count5) {
    const reverse5 = stop2 < start2;
    if (reverse5) [start2, stop2] = [stop2, start2];
  ...
  function tickInterval(start2, stop2, count5) {
    ...
    if (i3 === tickIntervals.length) return year5.every(tickStep2(start2 / durationYear2, stop2 / durationYear2, count5));
    if (i3 === 0) return millisecond_default2.every(Math.max(tickStep2(start2, stop2, count5), 1));
    const [t6, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
    return t6.every(step);
  }
  return [ticks, tickInterval];
...
function formatLocale(locale3) {
    ...
    return function(date) {
      ...
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          ...
          if (format2 = formats2[c11]) c11 = format2(date, pad2);
          string.push(c11);
          j3 = i3 + 1;
        }
      }
  ...
  function newParse(specifier, Z) {
    return function(string) {
      var d3 = newDate(1900, void 0, 1), i3 = parseSpecifier(d3, specifier, string += "", 0), week, day5;
      ...
      if ("V" in d3) {
        ...
        if (!("w" in d3)) d3.w = 1;
        if ("Z" in d3) {
          week = utcDate(newDate(d3.y, 0, 1)), day5 = week.getUTCDay();
          week = day5 > 4 || day5 === 0 ? utcMonday2.ceil(week) : utcMonday2(week);
          week = utcDay_default2.offset(week, (d3.V - 1) * 7);
          d3.y = week.getUTCFullYear();
          d3.m = week.getUTCMonth();
          d3.d = week.getUTCDate() + (d3.w + 6) % 7;
        } else {
          week = localDate(newDate(d3.y, 0, 1)), day5 = week.getDay();
          week = day5 > 4 || day5 === 0 ? monday2.ceil(week) : monday2(week);
        ...
        day5 = "Z" in d3 ? utcDate(newDate(d3.y, 0, 1)).getUTCDay() : localDate(newDate(d3.y, 0, 1)).getDay();
        d3.m = 0;
        d3.d = "W" in d3 ? (d3.w + 6) % 7 + d3.W * 7 - (day5 + 5) % 7 : d3.w + d3.U * 7 - (day5 + 6) % 7;
      }
      if ("Z" in d3) {
        d3.H += d3.Z / 100 | 0;
        d3.M += d3.Z % 100;
...
function dISO(d3) {
  var day5 = d3.getDay();
  return day5 >= 4 || day5 === 0 ? thursday2(d3) : thursday2.ceil(d3);
}
...
function formatFullYearISO(d3, p3) {
  var day5 = d3.getDay();
  d3 = day5 >= 4 || day5 === 0 ? thursday2(d3) : thursday2.ceil(d3);
  return pad(d3.getFullYear() % 1e4, p3, 4);
}
...
function UTCdISO(d3) {
  var day5 = d3.getUTCDay();
  return day5 >= 4 || day5 === 0 ? utcThursday2(d3) : utcThursday2.ceil(d3);
}
...
function formatUTCFullYearISO(d3, p3) {
  var day5 = d3.getUTCDay();
  d3 = day5 >= 4 || day5 === 0 ? utcThursday2(d3) : utcThursday2.ceil(d3);
  return pad(d3.getUTCFullYear() % 1e4, p3, 4);
}
...
function point5(that, t010, t110) {
  ...
  that._context.bezierCurveTo(x0 + dx, y0 + dx * t010, x1 - dx, y1 - dx * t110, x1, y1);
}
...
MonotoneX.prototype = {
  ...
  point: function(x5, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point5(this, slope2(this, t110 = slope3(this, x5, y4)), t110);
        break;
      default:
        point5(this, this._t0, t110 = slope3(this, x5, y4));
        break;
    }
    this._x0 = this._x1, this._x1 = x5;
    this._y0 = this._y1, this._y1 = y4;
...
function peak(series) {
  ...
  while (++i3 < n3) if ((vi2 = +series[i3][1]) > vj) vj = vi2, j3 = i3;
  return j3;
}
...
function insideOut_default(series) {
  var n3 = series.length, i3, j3, sums = series.map(sum3), order = appearance_default(series), top = 0, bottom = 0, tops = [], bottoms = [];
  for (i3 = 0; i3 < n3; ++i3) {
    j3 = order[i3];
    if (top < bottom) {
      top += sums[j3];
...
var Kr = function(e6, r3) {
  ...
  return Hr.forEach(function(e7) {
    void 0 === (0, import_get.default)(t6, e7 + ".fontFamily") && (0, import_set3.default)(t6, e7 + ".fontFamily", t6.text.fontFamily), void 0 === (0, import_get.default)(t6, e7 + ".fontSize") && (0, import_set3.default)(t6, e7 + ".fontSize", t6.text.fontSize), void 0 === (0, import_get.default)(t6, e7 + ".fill") && (0, import_set3.default)(t6, e7 + ".fill", t6.text.fill), void 0 === (0, import_get.default)(t6, e7 + ".outlineWidth") && (0, import_set3.default)(t6, e7 + ".outlineWidth", t6.text.outlineWidth), void 0 === (0, import_get.default)(t6, e7 + ".outlineColor") && (0, import_set3.default)(t6, e7 + ".outlineColor", t6.text.outlineColor);
  }), t6;
};
...
var tt = function(e6) {
  ...
  if (et[e6]) return quantize().range(et[e6]);
...
var vt = { ascending: ascending_default3, descending: descending_default4, insideOut: insideOut_default, none: none_default2, reverse: reverse_default };
      ...
      if (Xi(s5, r4, o3)) {
        ...
        if (f3) {
          if (Ui.includes(f3.type)) if ("inherit" === f3.background || "inherit" === f3.color) {
            ...
            "inherit" === f3.background && (b3 = b3 + ".bg." + p3, h2 = p3), "inherit" === f3.color && (b3 = b3 + ".fg." + p3, g3 = p3), (0, import_set3.default)(r4, d3, "url(#" + b3 + ")"), c11[b3] || (u3.push(Sr({}, f3, { id: b3, background: h2, color: g3 })), c11[b3] = 1);
          } else (0, import_set3.default)(r4, d3, "url(#" + a5 + ")");
            ...
            if (f3.colors.map(function(e7) {
              ...
              q.id = R, (0, import_set3.default)(r4, d3, "url(#" + R + ")"), c11[R] || (u3.push(q), c11[R] = 1);
            } else (0, import_set3.default)(r4, d3, "url(#" + a5 + ")");
          }
        }
        return "break";
...
var b = (0, import_react16.memo)(function(t6) {
  var o3, n3 = t6.position, r3 = t6.anchor, e6 = t6.children, l3 = Et(), u3 = Zr(), p3 = u3.animate, f3 = u3.config, b3 = Gt(), g3 = b3[0], w3 = b3[1], T3 = (0, import_react16.useRef)(false), C9 = void 0, E7 = false, P2 = w3.width > 0 && w3.height > 0, j3 = Math.round(n3[0]), N2 = Math.round(n3[1]);
  P2 && ("top" === r3 ? (j3 -= w3.width / 2, N2 -= w3.height + 14) : "right" === r3 ? (j3 += 14, N2 -= w3.height / 2) : "bottom" === r3 ? (j3 -= w3.width / 2, N2 += 14) : "left" === r3 ? (j3 -= w3.width + 14, N2 -= w3.height / 2) : "center" === r3 && (j3 -= w3.width / 2, N2 -= w3.height / 2), C9 = { transform: m2(j3, N2) }, T3.current || (E7 = true), T3.current = [j3, N2]);
...
define_default3(Cubehelix3, cubehelix5, extend3(Color3, {
  ...
  rgb: function() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians3, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh6 = Math.cos(h2), sinh6 = Math.sin(h2);
    return new Rgb3(
      255 * (l3 + a4 * (A4 * cosh6 + B3 * sinh6)),
      255 * (l3 + a4 * (C5 * cosh6 + D3 * sinh6)),
      255 * (l3 + a4 * (E4 * cosh6)),
      this.opacity
    );
  }
...
function basis3(t110, v0, v1, v22, v32) {
  var t26 = t110 * t110, t36 = t26 * t110;
  return ((1 - 3 * t110 + 3 * t26 - t36) * v0 + (4 - 6 * t26 + 3 * t36) * v1 + (1 + 3 * t110 + 3 * t26 - 3 * t36) * v22 + t36 * v32) / 6;
}
...
var rgb_default3 = function rgbGamma3(y4) {
  ...
  function rgb7(start2, end) {
    var r3 = color6((start2 = rgb4(start2)).r, (end = rgb4(end)).r), g3 = color6(start2.g, end.g), b3 = color6(start2.b, end.b), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function hsl7(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hsl6(start2)).h, (end = hsl6(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
function hcl6(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hcl5(start2)).h, (end = hcl5(end)).h), c11 = nogamma3(start2.c, end.c), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c11(t6);
      start2.l = l3(t6);
...
function cubehelix6(hue6) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix11(start2, end) {
      var h2 = hue6((start2 = cubehelix5(start2)).h, (end = cubehelix5(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
        start2.l = l3(Math.pow(t6, y4));
...
var e23 = Math.sqrt(2);
function tickStep3(start2, stop2, count5) {
  var step0 = Math.abs(stop2 - start2) / Math.max(0, count5), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
...
function ordinal2() {
  var index5 = /* @__PURE__ */ new Map(), domain = [], range = [], unknown = implicit2;
  function scale(d3) {
    var key = d3 + "", i3 = index5.get(key);
    if (!i3) {
      if (unknown !== implicit2) return unknown;
      index5.set(key, i3 = domain.push(d3));
    }
    return range[(i3 - 1) % range.length];
  }
...
function color4(format2) {
  var m4, l3;
  format2 = (format2 + "").trim().toLowerCase();
  return (m4 = reHex4.exec(format2)) ? (l3 = m4[1].length, m4 = parseInt(m4[1], 16), l3 === 6 ? rgbn4(m4) : l3 === 3 ? new Rgb4(m4 >> 8 & 15 | m4 >> 4 & 240, m4 >> 4 & 15 | m4 & 240, (m4 & 15) << 4 | m4 & 15, 1) : l3 === 8 ? rgba5(m4 >> 24 & 255, m4 >> 16 & 255, m4 >> 8 & 255, (m4 & 255) / 255) : l3 === 4 ? rgba5(m4 >> 12 & 15 | m4 >> 8 & 240, m4 >> 8 & 15 | m4 >> 4 & 240, m4 >> 4 & 15 | m4 & 240, ((m4 & 15) << 4 | m4 & 15) / 255) : null) : (m4 = reRgbInteger4.exec(format2)) ? new Rgb4(m4[1], m4[2], m4[3], 1) : (m4 = reRgbPercent4.exec(format2)) ? new Rgb4(m4[1] * 255 / 100, m4[2] * 255 / 100, m4[3] * 255 / 100, 1) : (m4 = reRgbaInteger4.exec(format2)) ? rgba5(m4[1], m4[2], m4[3], m4[4]) : (m4 = reRgbaPercent4.exec(format2)) ? rgba5(m4[1] * 255 / 100, m4[2] * 255 / 100, m4[3] * 255 / 100, m4[4]) : (m4 = reHslPercent4.exec(format2)) ? hsla5(m4[1], m4[2] / 100, m4[3] / 100, 1) : (m4 = reHslaPercent4.exec(format2)) ? hsla5(m4[1], m4[2] / 100, m4[3] / 100, m4[4]) : named4.hasOwnProperty(format2) ? rgbn4(named4[format2]) : format2 === "transparent" ? new Rgb4(NaN, NaN, NaN, 0) : null;
}
function rgbn4(n3) {
...
function rgbConvert4(o3) {
  if (!(o3 instanceof Color4)) o3 = color4(o3);
  if (!o3) return new Rgb4();
  o3 = o3.rgb();
...
function hslConvert4(o3) {
  if (o3 instanceof Hsl4) return new Hsl4(o3.h, o3.s, o3.l, o3.opacity);
  if (!(o3 instanceof Color4)) o3 = color4(o3);
  if (!o3) return new Hsl4();
  if (o3 instanceof Hsl4) return o3;
  o3 = o3.rgb();
  var r3 = o3.r / 255, g3 = o3.g / 255, b3 = o3.b / 255, min6 = Math.min(r3, g3, b3), max6 = Math.max(r3, g3, b3), h2 = NaN, s4 = max6 - min6, l3 = (max6 + min6) / 2;
  if (s4) {
    if (r3 === max6) h2 = (g3 - b3) / s4 + (g3 < b3) * 6;
...
function labConvert4(o3) {
  if (o3 instanceof Lab4) return new Lab4(o3.l, o3.a, o3.b, o3.opacity);
  if (o3 instanceof Hcl4) return hcl2lab4(o3);
  if (!(o3 instanceof Rgb4)) o3 = rgbConvert4(o3);
...
function hclConvert4(o3) {
  if (o3 instanceof Hcl4) return new Hcl4(o3.h, o3.c, o3.l, o3.opacity);
  if (!(o3 instanceof Lab4)) o3 = labConvert4(o3);
  if (o3.a === 0 && o3.b === 0) return new Hcl4(NaN, 0 < o3.l && o3.l < 100 ? 0 : NaN, o3.l, o3.opacity);
  var h2 = Math.atan2(o3.b, o3.a) * degrees7;
  return new Hcl4(h2 < 0 ? h2 + 360 : h2, Math.sqrt(o3.a * o3.a + o3.b * o3.b), o3.l, o3.opacity);
}
function hcl7(h2, c11, l3, opacity) {
  return arguments.length === 1 ? hclConvert4(h2) : new Hcl4(h2, c11, l3, opacity == null ? 1 : opacity);
}
function Hcl4(h2, c11, l3, opacity) {
  this.h = +h2;
  this.c = +c11;
  this.l = +l3;
  this.opacity = +opacity;
...
function hcl2lab4(o3) {
  if (isNaN(o3.h)) return new Lab4(o3.l, 0, 0, o3.opacity);
...
function cubehelixConvert4(o3) {
  if (o3 instanceof Cubehelix4) return new Cubehelix4(o3.h, o3.s, o3.l, o3.opacity);
  if (!(o3 instanceof Rgb4)) o3 = rgbConvert4(o3);
...
define_default4(Cubehelix4, cubehelix7, extend4(Color4, {
  ...
  rgb: function() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians4, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh6 = Math.cos(h2), sinh6 = Math.sin(h2);
    return new Rgb4(
      255 * (l3 + a4 * (A5 * cosh6 + B4 * sinh6)),
      255 * (l3 + a4 * (C6 * cosh6 + D4 * sinh6)),
      255 * (l3 + a4 * (E5 * cosh6)),
      this.opacity
    );
  }
...
function basis4(t110, v0, v1, v22, v32) {
  var t26 = t110 * t110, t36 = t26 * t110;
  return ((1 - 3 * t110 + 3 * t26 - t36) * v0 + (4 - 6 * t26 + 3 * t36) * v1 + (1 + 3 * t110 + 3 * t26 - 3 * t36) * v22 + t36 * v32) / 6;
}
...
function hue4(a4, b3) {
  var d3 = b3 - a4;
  return d3 ? linear5(a4, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default8(isNaN(a4) ? b3 : a4);
}
function gamma4(y4) {
...
function nogamma4(a4, b3) {
  var d3 = b3 - a4;
  return d3 ? linear5(a4, d3) : constant_default8(isNaN(a4) ? b3 : a4);
}
...
var rgb_default4 = function rgbGamma4(y4) {
  ...
  function rgb7(start2, end) {
    var r3 = color6((start2 = rgb5(start2)).r, (end = rgb5(end)).r), g3 = color6(start2.g, end.g), b3 = color6(start2.b, end.b), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function decompose_default4(a4, b3, c11, d3, e6, f3) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b3 * b3)) a4 /= scaleX, b3 /= scaleX;
  if (skewX = a4 * c11 + b3 * d3) c11 -= a4 * skewX, d3 -= b3 * skewX;
  if (scaleY = Math.sqrt(c11 * c11 + d3 * d3)) c11 /= scaleY, d3 /= scaleY, skewX /= scaleY;
...
function parseCss4(value) {
  const m4 = new (typeof DOMMatrix === "function" ? DOMMatrix : WebKitCSSMatrix)(value + "");
  return m4.isIdentity ? identity6 : decompose_default4(m4.a, m4.b, m4.c, m4.d, m4.e, m4.f);
}
...
function hsl9(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hsl8(start2)).h, (end = hsl8(end)).h), s4 = nogamma4(start2.s, end.s), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
function hcl8(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hcl7(start2)).h, (end = hcl7(end)).h), c11 = nogamma4(start2.c, end.c), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c11(t6);
      start2.l = l3(t6);
...
function cubehelix8(hue6) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix11(start2, end) {
      var h2 = hue6((start2 = cubehelix7(start2)).h, (end = cubehelix7(end)).h), s4 = nogamma4(start2.s, end.s), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
        start2.l = l3(Math.pow(t6, y4));
...
var cubehelix_default6 = cubehelix8(hue4);
...
function newInterval3(floori, offseti, count5, field) {
  function interval(date) {
    return floori(date = arguments.length === 0 ? /* @__PURE__ */ new Date() : /* @__PURE__ */ new Date(+date)), date;
  }
  interval.floor = function(date) {
  ...
  if (count5) {
    interval.count = function(start2, end) {
      ...
      return Math.floor(count5(t07, t17));
    };
    interval.every = function(step) {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval : interval.filter(field ? function(d3) {
...
function ticker3(year5, month5, week, day5, hour5, minute5) {
  const tickIntervals = [
    ...
    [minute5, 1, durationMinute3],
    [minute5, 5, 5 * durationMinute3],
    [minute5, 15, 15 * durationMinute3],
    [minute5, 30, 30 * durationMinute3],
    [hour5, 1, durationHour3],
    [hour5, 3, 3 * durationHour3],
    [hour5, 6, 6 * durationHour3],
    [hour5, 12, 12 * durationHour3],
    [day5, 1, durationDay3],
    [day5, 2, 2 * durationDay3],
    [week, 1, durationWeek3],
    [month5, 1, durationMonth3],
    [month5, 3, 3 * durationMonth3],
    [year5, 1, durationYear3]
  ];
  function ticks(start2, stop2, count5) {
    const reverse5 = stop2 < start2;
    if (reverse5) [start2, stop2] = [stop2, start2];
  ...
  function tickInterval(start2, stop2, count5) {
    ...
    if (i3 === tickIntervals.length) return year5.every(tickStep3(start2 / durationYear3, stop2 / durationYear3, count5));
    if (i3 === 0) return millisecond_default3.every(Math.max(tickStep3(start2, stop2, count5), 1));
    const [t6, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
    return t6.every(step);
  }
  return [ticks, tickInterval];
...
var fr = function(e6, r3) {
  ...
  if ((0, import_isPlainObject2.default)(e6)) {
    ...
    if (function(e7) {
      ...
      if (Fe(e6.scheme)) {
        var i3 = ordinal2($e[e6.scheme]), u3 = function(e7) {
          return i3(n3(e7));
        };
      ...
      if (He(e6.scheme)) {
        ...
        var a4 = ordinal2($e[e6.scheme][e6.size || 11]), l3 = function(e7) {
          return a4(n3(e7));
        };
      ...
      if (Je(e6.scheme)) {
        ...
        var s4 = ordinal2($e[e6.scheme][e6.size || 9]), c11 = function(e7) {
          return s4(n3(e7));
        };
...
function ascending_default5(a4, b3) {
  return a4 < b3 ? -1 : a4 > b3 ? 1 : a4 >= b3 ? 0 : NaN;
}
...
var e24 = Math.sqrt(2);
function tickStep4(start2, stop2, count5) {
  var step0 = Math.abs(stop2 - start2) / Math.max(0, count5), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
  if (error >= e104) step1 *= 10;
  else if (error >= e54) step1 *= 5;
  else if (error >= e24) step1 *= 2;
  return stop2 < start2 ? -step1 : step1;
}
...
function color5(format2) {
  var m4, l3;
  format2 = (format2 + "").trim().toLowerCase();
  return (m4 = reHex5.exec(format2)) ? (l3 = m4[1].length, m4 = parseInt(m4[1], 16), l3 === 6 ? rgbn5(m4) : l3 === 3 ? new Rgb5(m4 >> 8 & 15 | m4 >> 4 & 240, m4 >> 4 & 15 | m4 & 240, (m4 & 15) << 4 | m4 & 15, 1) : l3 === 8 ? rgba6(m4 >> 24 & 255, m4 >> 16 & 255, m4 >> 8 & 255, (m4 & 255) / 255) : l3 === 4 ? rgba6(m4 >> 12 & 15 | m4 >> 8 & 240, m4 >> 8 & 15 | m4 >> 4 & 240, m4 >> 4 & 15 | m4 & 240, ((m4 & 15) << 4 | m4 & 15) / 255) : null) : (m4 = reRgbInteger5.exec(format2)) ? new Rgb5(m4[1], m4[2], m4[3], 1) : (m4 = reRgbPercent5.exec(format2)) ? new Rgb5(m4[1] * 255 / 100, m4[2] * 255 / 100, m4[3] * 255 / 100, 1) : (m4 = reRgbaInteger5.exec(format2)) ? rgba6(m4[1], m4[2], m4[3], m4[4]) : (m4 = reRgbaPercent5.exec(format2)) ? rgba6(m4[1] * 255 / 100, m4[2] * 255 / 100, m4[3] * 255 / 100, m4[4]) : (m4 = reHslPercent5.exec(format2)) ? hsla6(m4[1], m4[2] / 100, m4[3] / 100, 1) : (m4 = reHslaPercent5.exec(format2)) ? hsla6(m4[1], m4[2] / 100, m4[3] / 100, m4[4]) : named5.hasOwnProperty(format2) ? rgbn5(named5[format2]) : format2 === "transparent" ? new Rgb5(NaN, NaN, NaN, 0) : null;
}
function rgbn5(n3) {
...
function rgbConvert5(o3) {
  if (!(o3 instanceof Color5)) o3 = color5(o3);
  if (!o3) return new Rgb5();
  o3 = o3.rgb();
...
function hslConvert5(o3) {
  if (o3 instanceof Hsl5) return new Hsl5(o3.h, o3.s, o3.l, o3.opacity);
  if (!(o3 instanceof Color5)) o3 = color5(o3);
  if (!o3) return new Hsl5();
  if (o3 instanceof Hsl5) return o3;
  o3 = o3.rgb();
  var r3 = o3.r / 255, g3 = o3.g / 255, b3 = o3.b / 255, min6 = Math.min(r3, g3, b3), max6 = Math.max(r3, g3, b3), h2 = NaN, s4 = max6 - min6, l3 = (max6 + min6) / 2;
  if (s4) {
    if (r3 === max6) h2 = (g3 - b3) / s4 + (g3 < b3) * 6;
...
function hsl10(h2, s4, l3, opacity) {
...
define_default5(Hsl5, hsl10, extend5(Color5, {
  brighter: function(k4) {
    k4 = k4 == null ? brighter5 : Math.pow(brighter5, k4);
...
function labConvert5(o3) {
  if (o3 instanceof Lab5) return new Lab5(o3.l, o3.a, o3.b, o3.opacity);
  if (o3 instanceof Hcl5) return hcl2lab5(o3);
  if (!(o3 instanceof Rgb5)) o3 = rgbConvert5(o3);
...
function lab9(l3, a4, b3, opacity) {
...
function xyz2lab5(t6) {
  return t6 > t35 ? Math.pow(t6, 1 / 3) : t6 / t25 + t08;
}
function lab2xyz5(t6) {
  return t6 > t18 ? t6 * t6 * t6 : t25 * (t6 - t08);
}
...
function hclConvert5(o3) {
  if (o3 instanceof Hcl5) return new Hcl5(o3.h, o3.c, o3.l, o3.opacity);
  if (!(o3 instanceof Lab5)) o3 = labConvert5(o3);
  if (o3.a === 0 && o3.b === 0) return new Hcl5(NaN, 0 < o3.l && o3.l < 100 ? 0 : NaN, o3.l, o3.opacity);
  var h2 = Math.atan2(o3.b, o3.a) * degrees9;
  return new Hcl5(h2 < 0 ? h2 + 360 : h2, Math.sqrt(o3.a * o3.a + o3.b * o3.b), o3.l, o3.opacity);
}
function hcl9(h2, c11, l3, opacity) {
  return arguments.length === 1 ? hclConvert5(h2) : new Hcl5(h2, c11, l3, opacity == null ? 1 : opacity);
}
function Hcl5(h2, c11, l3, opacity) {
  this.h = +h2;
  this.c = +c11;
...
function hcl2lab5(o3) {
  if (isNaN(o3.h)) return new Lab5(o3.l, 0, 0, o3.opacity);
...
function cubehelixConvert5(o3) {
  if (o3 instanceof Cubehelix5) return new Cubehelix5(o3.h, o3.s, o3.l, o3.opacity);
  if (!(o3 instanceof Rgb5)) o3 = rgbConvert5(o3);
  var r3 = o3.r / 255, g3 = o3.g / 255, b3 = o3.b / 255, l3 = (BC_DA5 * b3 + ED5 * r3 - EB5 * g3) / (BC_DA5 + ED5 - EB5), bl = b3 - l3, k4 = (E6 * (g3 - l3) - C7 * bl) / D5, s4 = Math.sqrt(k4 * k4 + bl * bl) / (E6 * l3 * (1 - l3)), h2 = s4 ? Math.atan2(k4, bl) * degrees9 - 120 : NaN;
  return new Cubehelix5(h2 < 0 ? h2 + 360 : h2, s4, l3, o3.opacity);
}
function cubehelix9(h2, s4, l3, opacity) {
...
define_default5(Cubehelix5, cubehelix9, extend5(Color5, {
  ...
  rgb: function() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians5, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh6 = Math.cos(h2), sinh6 = Math.sin(h2);
    return new Rgb5(
      255 * (l3 + a4 * (A6 * cosh6 + B5 * sinh6)),
      255 * (l3 + a4 * (C7 * cosh6 + D5 * sinh6)),
      255 * (l3 + a4 * (E6 * cosh6)),
      this.opacity
    );
  }
...
function basis5(t110, v0, v1, v22, v32) {
  var t26 = t110 * t110, t36 = t26 * t110;
  return ((1 - 3 * t110 + 3 * t26 - t36) * v0 + (4 - 6 * t26 + 3 * t36) * v1 + (1 + 3 * t110 + 3 * t26 - 3 * t36) * v22 + t36 * v32) / 6;
}
function basis_default6(values) {
  ...
  return function(t6) {
    var i3 = t6 <= 0 ? t6 = 0 : t6 >= 1 ? (t6 = 1, n3 - 1) : Math.floor(t6 * n3), v1 = values[i3], v22 = values[i3 + 1], v0 = i3 > 0 ? values[i3 - 1] : 2 * v1 - v22, v32 = i3 < n3 - 1 ? values[i3 + 2] : 2 * v22 - v1;
    return basis5((t6 - i3 / n3) * n3, v0, v1, v22, v32);
  };
}
...
var constant_default10 = (x5) => () => x5;

// node_modules/@nivo/legends/node_modules/d3-interpolate/src/color.js
function linear7(a4, d3) {
  return function(t6) {
    return a4 + t6 * d3;
  };
}
function exponential5(a4, b3, y4) {
  return a4 = Math.pow(a4, y4), b3 = Math.pow(b3, y4) - a4, y4 = 1 / y4, function(t6) {
    return Math.pow(a4 + t6 * b3, y4);
  };
}
function hue5(a4, b3) {
  var d3 = b3 - a4;
  return d3 ? linear7(a4, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default10(isNaN(a4) ? b3 : a4);
}
function gamma5(y4) {
  return (y4 = +y4) === 1 ? nogamma5 : function(a4, b3) {
    return b3 - a4 ? exponential5(a4, b3, y4) : constant_default10(isNaN(a4) ? b3 : a4);
  };
}
function nogamma5(a4, b3) {
  var d3 = b3 - a4;
  return d3 ? linear7(a4, d3) : constant_default10(isNaN(a4) ? b3 : a4);
}

// node_modules/@nivo/legends/node_modules/d3-interpolate/src/rgb.js
var rgb_default5 = function rgbGamma5(y4) {
  var color6 = gamma5(y4);
  function rgb7(start2, end) {
    var r3 = color6((start2 = rgb6(start2)).r, (end = rgb6(end)).r), g3 = color6(start2.g, end.g), b3 = color6(start2.b, end.b), opacity = nogamma5(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function number_default9(a4, b3) {
  return a4 = +a4, b3 = +b3, function(t6) {
    return a4 * (1 - t6) + b3 * t6;
  };
}
...
function decompose_default5(a4, b3, c11, d3, e6, f3) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b3 * b3)) a4 /= scaleX, b3 /= scaleX;
  if (skewX = a4 * c11 + b3 * d3) c11 -= a4 * skewX, d3 -= b3 * skewX;
  if (scaleY = Math.sqrt(c11 * c11 + d3 * d3)) c11 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  ...
  return {
    translateX: e6,
    translateY: f3,
    rotate: Math.atan2(b3, a4) * degrees10,
    skewX: Math.atan(skewX) * degrees10,
    scaleX,
    scaleY
  };
}
...
function parseCss5(value) {
  const m4 = new (typeof DOMMatrix === "function" ? DOMMatrix : WebKitCSSMatrix)(value + "");
  return m4.isIdentity ? identity9 : decompose_default5(m4.a, m4.b, m4.c, m4.d, m4.e, m4.f);
}
function parseSvg5(value) {
  if (value == null) return identity9;
  if (!svgNode5) svgNode5 = document.createElementNS("http://www.w3.org/2000/svg", "g");
  svgNode5.setAttribute("transform", value);
  if (!(value = svgNode5.transform.baseVal.consolidate())) return identity9;
  value = value.matrix;
...
function interpolateTransform5(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s4, q) {
    if (xa !== xb || ya !== yb) {
      var i3 = s4.push("translate(", null, pxComma, null, pxParen);
      q.push({ i: i3 - 4, x: number_default9(xa, xb) }, { i: i3 - 2, x: number_default9(ya, yb) });
    } else if (xb || yb) {
      s4.push("translate(" + xb + pxComma + yb + pxParen);
    }
  }
  function rotate(a4, b3, s4, q) {
    if (a4 !== b3) {
      ...
      q.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default9(a4, b3) });
    } else if (b3) {
      s4.push(pop(s4) + "rotate(" + b3 + degParen);
    }
  }
  function skewX(a4, b3, s4, q) {
    if (a4 !== b3) {
      q.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default9(a4, b3) });
    } else if (b3) {
      s4.push(pop(s4) + "skewX(" + b3 + degParen);
    }
  }
...
var zoom_default5 = function zoomRho5(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon25) {
      ...
      S2 = (r1 - r0) / rho;
      i3 = function(t6) {
        var s4 = t6 * S2, coshr0 = cosh5(r0), u3 = w0 / (rho2 * d1) * (coshr0 * tanh5(rho * s4 + r0) - sinh5(r0));
        return [
          ux0 + u3 * dx,
          uy0 + u3 * dy,
...
function hsl11(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hsl10(start2)).h, (end = hsl10(end)).h), s4 = nogamma5(start2.s, end.s), l3 = nogamma5(start2.l, end.l), opacity = nogamma5(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
var hsl_default5 = hsl11(hue5);
var hslLong5 = hsl11(nogamma5);

// node_modules/@nivo/legends/node_modules/d3-interpolate/src/hcl.js
function hcl10(hue6) {
  return function(start2, end) {
    var h2 = hue6((start2 = hcl9(start2)).h, (end = hcl9(end)).h), c11 = nogamma5(start2.c, end.c), l3 = nogamma5(start2.l, end.l), opacity = nogamma5(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c11(t6);
      start2.l = l3(t6);
...
function cubehelix10(hue6) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix11(start2, end) {
      var h2 = hue6((start2 = cubehelix9(start2)).h, (end = cubehelix9(end)).h), s4 = nogamma5(start2.s, end.s), l3 = nogamma5(start2.l, end.l), opacity = nogamma5(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
        start2.l = l3(Math.pow(t6, y4));
...
var cubehelix_default7 = cubehelix10(hue5);
...
function newInterval4(floori, offseti, count5, field) {
  function interval(date) {
    return floori(date = arguments.length === 0 ? /* @__PURE__ */ new Date() : /* @__PURE__ */ new Date(+date)), date;
  }
  interval.floor = function(date) {
  ...
  interval.filter = function(test) {
    return newInterval4(function(date) {
      if (date >= date) while (floori(date), !test(date)) date.setTime(date - 1);
    }, function(date, step) {
      if (date >= date) {
        if (step < 0) while (++step <= 0) {
  ...
  if (count5) {
    interval.count = function(start2, end) {
      ...
      return Math.floor(count5(t09, t19));
    };
    interval.every = function(step) {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval : interval.filter(field ? function(d3) {
...
millisecond4.every = function(k4) {
  k4 = Math.floor(k4);
  if (!isFinite(k4) || !(k4 > 0)) return null;
  if (!(k4 > 1)) return millisecond4;
  return newInterval4(function(date) {
    date.setTime(Math.floor(date / k4) * k4);
  }, function(date, step) {
    date.setTime(+date + step * k4);
...
var second4 = newInterval4(function(date) {
  date.setTime(date - date.getMilliseconds());
}, function(date, step) {
  date.setTime(+date + step * durationSecond4);
}, function(start2, end) {
...
var minute4 = newInterval4(function(date) {
  date.setTime(date - date.getMilliseconds() - date.getSeconds() * durationSecond4);
}, function(date, step) {
  date.setTime(+date + step * durationMinute4);
}, function(start2, end) {
...
var hour4 = newInterval4(function(date) {
  date.setTime(date - date.getMilliseconds() - date.getSeconds() * durationSecond4 - date.getMinutes() * durationMinute4);
}, function(date, step) {
  date.setTime(+date + step * durationHour4);
}, function(start2, end) {
...
var month4 = newInterval4(function(date) {
  date.setDate(1);
  date.setHours(0, 0, 0, 0);
}, function(date, step) {
  date.setMonth(date.getMonth() + step);
...
var year4 = newInterval4(function(date) {
  date.setMonth(0, 1);
  date.setHours(0, 0, 0, 0);
}, function(date, step) {
  date.setFullYear(date.getFullYear() + step);
...
year4.every = function(k4) {
  return !isFinite(k4 = Math.floor(k4)) || !(k4 > 0) ? null : newInterval4(function(date) {
    date.setFullYear(Math.floor(date.getFullYear() / k4) * k4);
    date.setMonth(0, 1);
    date.setHours(0, 0, 0, 0);
  }, function(date, step) {
...
var utcMinute4 = newInterval4(function(date) {
  date.setUTCSeconds(0, 0);
}, function(date, step) {
  date.setTime(+date + step * durationMinute4);
}, function(start2, end) {
...
var utcHour4 = newInterval4(function(date) {
  date.setUTCMinutes(0, 0, 0);
}, function(date, step) {
  date.setTime(+date + step * durationHour4);
}, function(start2, end) {
...
var utcDay4 = newInterval4(function(date) {
  date.setUTCHours(0, 0, 0, 0);
}, function(date, step) {
  date.setUTCDate(date.getUTCDate() + step);
}, function(start2, end) {
...
var utcMonth4 = newInterval4(function(date) {
  date.setUTCDate(1);
  date.setUTCHours(0, 0, 0, 0);
}, function(date, step) {
  date.setUTCMonth(date.getUTCMonth() + step);
...
var utcYear4 = newInterval4(function(date) {
  date.setUTCMonth(0, 1);
  date.setUTCHours(0, 0, 0, 0);
}, function(date, step) {
  date.setUTCFullYear(date.getUTCFullYear() + step);
...
function ticker4(year5, month5, week, day5, hour5, minute5) {
  const tickIntervals = [
    ...
    [minute5, 1, durationMinute4],
    [minute5, 5, 5 * durationMinute4],
    [minute5, 15, 15 * durationMinute4],
    [minute5, 30, 30 * durationMinute4],
    [hour5, 1, durationHour4],
    [hour5, 3, 3 * durationHour4],
    [hour5, 6, 6 * durationHour4],
    [hour5, 12, 12 * durationHour4],
    [day5, 1, durationDay4],
    [day5, 2, 2 * durationDay4],
    [week, 1, durationWeek4],
    [month5, 1, durationMonth4],
    [month5, 3, 3 * durationMonth4],
    [year5, 1, durationYear4]
  ];
  function ticks(start2, stop2, count5) {
    const reverse5 = stop2 < start2;
    if (reverse5) [start2, stop2] = [stop2, start2];
  ...
  function tickInterval(start2, stop2, count5) {
    const target = Math.abs(stop2 - start2) / count5;
    const i3 = bisector_default4(([, , step2]) => step2).right(tickIntervals, target);
    if (i3 === tickIntervals.length) return year5.every(tickStep4(start2 / durationYear4, stop2 / durationYear4, count5));
    if (i3 === 0) return millisecond_default4.every(Math.max(tickStep4(start2, stop2, count5), 1));
    const [t6, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
    return t6.every(step);
  }
  return [ticks, tickInterval];
}
var [utcTicks4, utcTickInterval4] = ticker4(utcYear_default4, utcMonth_default4, utcSunday4, utcDay_default4, utcHour_default4, utcMinute_default4);
var [timeTicks4, timeTickInterval4] = ticker4(year_default4, month_default4, sunday4, day_default4, hour_default4, minute_default4);
...
var B6 = function(i3) {
  var n3, r3, l3, c11, h2, g3, m4, f3, u3, v4, y4, b3 = i3.x, k4 = i3.y, x5 = i3.width, A7 = i3.height, W2 = i3.data, O3 = i3.direction, z3 = void 0 === O3 ? "left-to-right" : O3, B7 = i3.justify, w3 = void 0 !== B7 && B7, X2 = i3.textColor, Y2 = i3.background, H2 = void 0 === Y2 ? "transparent" : Y2, E7 = i3.opacity, j3 = void 0 === E7 ? 1 : E7, T3 = i3.symbolShape, L = void 0 === T3 ? "square" : T3, M2 = i3.symbolSize, F2 = void 0 === M2 ? 16 : M2, P2 = i3.symbolSpacing, R = void 0 === P2 ? 8 : P2, q = i3.symbolBorderWidth, V2 = void 0 === q ? 0 : q, D6 = i3.symbolBorderColor, G = void 0 === D6 ? "transparent" : D6, I = i3.onClick, N2 = i3.onMouseEnter, _ = i3.onMouseLeave, J = i3.toggleSerie, K6 = i3.effects, Q = (0, import_react18.useState)({}), U = Q[0], Z = Q[1], $ = Et(), tt2 = (0, import_react18.useCallback)(function(t6) {
    if (K6) {
    ...
    null == _ || _(W2, t6);
  }, [_, W2, K6]), it2 = S({ direction: z3, justify: w3, symbolSize: null != (n3 = U.symbolSize) ? n3 : F2, symbolSpacing: R, width: x5, height: A7 }), nt = it2.symbolX, ot = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct2 = it2.labelAlignment, st = [I, N2, _, J].some(function(t6) {
    return void 0 !== t6;
  }), dt2 = "function" == typeof L ? L : C8[L];
...
var w2 = function(e6) {
  ...
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(B6, { data: e7, x: i4 * E7 + H2.left, y: i4 * j3 + H2.top, width: d3, height: h2, direction: m4, justify: c11, effects: s4, textColor: v4, background: y4, opacity: x5, symbolShape: S2, symbolSize: A7, symbolSpacing: W2, symbolBorderWidth: O3, symbolBorderColor: z3, onClick: C9, onMouseEnter: w3, onMouseLeave: X2, toggleSerie: Y2 }, i4);
  }) });
};
var X = function(e6) {
...
var H = function(t6, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a4 = e6.translateY, c11 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, m4 = e6.justify, f3 = void 0 !== m4 && m4, u3 = e6.itemsSpacing, v4 = void 0 === u3 ? 0 : u3, p3 = e6.itemWidth, y4 = e6.itemHeight, b3 = e6.itemDirection, A7 = void 0 === b3 ? "left-to-right" : b3, W2 = e6.itemTextColor, O3 = e6.symbolSize, z3 = void 0 === O3 ? 16 : O3, C9 = e6.symbolSpacing, B7 = void 0 === C9 ? 8 : C9, w3 = e6.theme, X2 = k3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: v4, direction: d3, padding: g3 }), H2 = X2.width, E7 = X2.height, j3 = X2.padding, T3 = x4({ anchor: s4, translateX: l3, translateY: c11, containerWidth: n3, containerHeight: o3, width: H2, height: E7 }), L = T3.x, M2 = T3.y, F2 = "row" === d3 ? p3 + v4 : 0, P2 = "column" === d3 ? y4 + v4 : 0;
  t6.save(), t6.translate(L, M2), t6.font = w3.legends.text.fontSize + "px " + (w3.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r4 = i4 * F2 + j3.left, l4 = i4 * P2 + j3.top, a5 = S({ direction: A7, justify: f3, symbolSize: z3, symbolSpacing: B7, width: p3, height: y4 }), c12 = a5.symbolX, s5 = a5.symbolY, d4 = a5.labelX, h3 = a5.labelY, g4 = a5.labelAnchor, m5 = a5.labelAlignment;
...
//# sourceMappingURL=chunk-BQN4OYG4.js.map
